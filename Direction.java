...
public class Direction {
    ...
    public boolean intersects(Rectangle r, int dim) {
        for (Point p : this.points) {
            if (new PathBlock(p, dim).intersects(r)) {
                return true;
            }
        }
        return false;
    ...
    public Direction(Point p1, Point p2, int distance) {
        this.p1 = p1;
        ...
        if (horizontal) {
            ...
            this.p2 = this.points.get(this.points.size() - 1);
            return;
        }
